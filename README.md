...
2. Set the ASAF_HOME environment variable to point to the root directory.  For example:

	For Bash:      export ASAF_HOME=".../AppScan-Automation-Framework"

	For Windows:   set ASAF_HOME=...\AppScan-Automation-Framework
